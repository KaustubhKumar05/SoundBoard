...
function App() {
  ...
  const [boardConfig, setBoardConfig] = useState({
    buttons: [
      { keyBinding: "q", note: "C4", duration: "1", id: "asdf" },
      { keyBinding: "w", note: "E4", duration: "1", id: "qwe" },
      { keyBinding: "e", note: "G4", duration: "1", id: "rewrwes" },
      { keyBinding: "r", note: "C5", duration: "1", id: "rewd" },
      { keyBinding: "a", note: "D4", duration: "1", id: "refdw" },
      { keyBinding: "s", note: "A4", duration: "1", id: "tgfv" },
      { keyBinding: "d", note: "E5", duration: "1", id: "yi" },
      { keyBinding: "f", note: "G5", duration: "1", id: "iuo" },
      { keyBinding: "z", note: "D5", duration: "1", id: "fdsgz" },
      { keyBinding: "x", note: "A5", duration: "1", id: "lk" },
      { keyBinding: "c", note: "E6", duration: "1", id: "ryt" },
      { keyBinding: "v", note: "C6", duration: "1", id: "cvxb" },
    ],
    loops: [
      { keyBinding: "p", note: "C1", duration: "1", interval: 1, id: "ihj" },
      { keyBinding: "l", note: "E2", duration: "1", interval: 1, id: "jbhkn" },
      { keyBinding: "m", note: "C3", duration: "1", interval: 1, id: "dsf" },
    ],
  });
